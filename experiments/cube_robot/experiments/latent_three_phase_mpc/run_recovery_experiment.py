    ...
    if args.stage in ("adapt", "all"):
        if trained_models is None:
            ...
            (
                ...
                action_mean,
                action_scale,
            ) = load_checkpoint(source_checkpoint, config, device)
        else:
